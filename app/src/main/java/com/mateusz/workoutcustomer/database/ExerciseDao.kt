...
interface ExerciseDao{
    ...
    @Query("UPDATE exercise_table SET timeCheck=:timeCheck WHERE _id LIKE :ID")
    fun updateExerciseTimeCheck(timeCheck : Boolean, ID : Int)
    ...
    fun updateExerciseRepeat(repeat : String, ID : Int)

    @Query("UPDATE exercise_table SET pause=:pause WHERE _id LIKE :ID")
    fun updateExercisePause(pause : String, ID : Int)
